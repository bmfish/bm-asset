...
public class BigNumberUtils {
	 ...
	 * @return 两个参数的积
	 */
	public static long mulLong(long v1, long v2) {
		BigDecimal b1 = new BigDecimal(Long.valueOf(v1));
		BigDecimal b2 = new BigDecimal(Long.valueOf(v2));
	...
	public static void main(String[] args) {
		...
		// 计算阶乘，可以将n设得更大
		int n = 30;
		System.out.println("计算n的阶乘" + n + "! = " + BigNumberUtils.getFactorial(n));
		// 用double构造BigDecimal
		...
		// 进行精确计算
		System.out.println("(0.4+0.2)*250 = "
				+ BigNumberUtils.mul(BigNumberUtils.add(0.4, 0.2), 250));
		System.out.println("1.0 - 0.42 = " + BigNumberUtils.sub(1.0, 0.42));
		System.out.println("4.015 * 100 =" + BigNumberUtils.add(4.015, 100));
		System.out.println("123.3 / 100 = " + BigNumberUtils.add(123.3, 100));
		System.out.println(BigNumberUtils.mul(0.05, 1.86));
		System.out.println(0.05*1.86);
	}
}
